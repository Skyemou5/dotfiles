_atuin() {
    ...
    case "${cmd}" in
        atuin)
            opts="-h -V --help --version history import stats search sync login logout register key status account kv server init uuid contributors gen-completions help"
            ...
            ;;
        atuin__account)
            opts="-h --help login register logout delete help"
        ...
        atuin__account__help)
            opts="login register logout delete help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        atuin__gen__completions)
            ...
            ;;
        atuin__help)
            opts="history import stats search sync login logout register key status account kv server init uuid contributors gen-completions help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        atuin__help__account)
            opts="login register logout delete"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        atuin__help__history__start)
            ...
            ;;
        atuin__help__import)
            opts="auto zsh zsh-hist-db bash resh fish nu nu-hist-db"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        atuin__help__uuid)
            ...
            ;;
        atuin__history)
            opts="-h --help start end list last help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        atuin__history__last)
            opts="-f -h --human --cmd-only --format --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        atuin__history__list)
            opts="-c -s -f -h --cwd --session --human --cmd-only --format --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        atuin__history__start)
            ...
            ;;
        atuin__import)
            opts="-h --help auto zsh zsh-hist-db bash resh fish nu nu-hist-db help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        atuin__import__fish)
            ...
            ;;
        atuin__import__help)
            opts="auto zsh zsh-hist-db bash resh fish nu nu-hist-db help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        atuin__import__zsh__hist__db)
            ...
            ;;
        atuin__init)
            opts="-h --disable-ctrl-r --disable-up-arrow --help zsh bash fish nu"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        atuin__register)
            ...
            ;;
        atuin__search)
            opts="-c -e -b -i -r -f -h --cwd --exclude-cwd --exit --exclude-exit --before --after --limit --offset --interactive --filter-mode --search-mode --shell-up-key-binding --human --cmd-only --delete --delete-it-all --reverse --format --inline-height --help [QUERY]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
